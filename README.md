...
- 저장소: `nais-kr/ai-agent-catalog`
- 사이트: https://nais-kr.github.io/ai-agent-catalog/
- 데이터: [`agents.csv`](agents.csv) — **이 파일만 수정·푸시하면 사이트가 자동 갱신됩니다.**
...
- 게시 주소: **https://nais-kr.github.io/ai-agent-catalog/** (상대경로 기반, 별도 도메인/설정 불필요)
